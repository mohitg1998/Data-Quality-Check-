...
def insert_mock_data(conn):
    ...
    cursor.executemany("INSERT INTO Customers (CustomerID, Name, Email, Phone) VALUES (?, ?, ?, ?)", customers)
    
    # Insert mock data for Accounts
    accounts = [
    ...
    cursor.executemany("INSERT INTO Accounts (AccountID, CustomerID, AccountType, Balance) VALUES (?, ?, ?, ?)", accounts)
    ...
    cursor.executemany("INSERT INTO Transactions (TransactionID, AccountID, TransactionDate, Amount, Type) VALUES (?, ?, ?, ?, ?)", transactions)
    
    # Insert mock data for Loans
    loans = [
    ...
    cursor.executemany("INSERT INTO Loans (LoanID, CustomerID, LoanAmount, InterestRate, StartDate, EndDate) VALUES (?, ?, ?, ?, ?, ?)", loans)
...
if __name__ == "__main__":
    ...
    db_path = os.path.join(db_dir, "source_data.sqlite")
    ...
    print("Mock SQLite database created successfully at:", db_path)
